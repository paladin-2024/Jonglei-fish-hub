        ...
        child: Column(
          ...
          children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(user?.roleDisplay ?? 'Fish Trader',
                              style: const TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w600)),
                        ),
                      ],
                    ),
                  ),
                  const Icon(Icons.storefront_rounded, color: Colors.white, size: 52),
                ],
              ),
            ),
            ...
            GridView.count(
              ...
              children: const [
                _ActionCard(icon: Icons.add_circle_outline_rounded, label: 'New Listing', color: Color(0xFF00695C)),
                _ActionCard(icon: Icons.inventory_2_outlined, label: 'My Listings', color: Color(0xFF00897B)),
                _ActionCard(icon: Icons.receipt_long_outlined, label: 'Orders', color: Color(0xFF26A69A)),
                _ActionCard(icon: Icons.bar_chart_rounded, label: 'Analytics', color: Color(0xFF4DB6AC)),
              ],
            ),
          ],
        ),
